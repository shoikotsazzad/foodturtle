...
export default function CartBottomBar() {
  ...
  return (
    <Link
      href="/checkout"
      className="fixed bottom-16 sm:bottom-4 left-4 right-4 max-w-lg mx-auto z-30 bg-turtle-pink text-white rounded-full px-4 py-3 flex items-center justify-between shadow-xl hover:bg-turtle-pink-light transition-colors"
    >
