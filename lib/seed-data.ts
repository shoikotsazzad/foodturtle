...
const CUISINE_IMAGE_MAP: Record<string, string> = {
  ...
  Lebanese: "https://images.unsplash.com/photo-1529006557810-274b9b2fc783",
  Western: "https://images.unsplash.com/photo-1546964124-0cce460f38ef",
  Curry: "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0",
  Sweets: "https://images.unsplash.com/photo-1578985545062-69928b1d9587",
  Meat: "https://images.unsplash.com/photo-1544025162-d76694265947",
  Beverage: "https://images.unsplash.com/photo-1622597467836-f3285f2131b8",
  Khichuri: "https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd",
  Cakes: "https://images.unsplash.com/photo-1578985545062-69928b1d9587",
  Mexican: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd",
  Pasta: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38",
};
...
const RAW_DHAKA_RESTAURANTS: RawRestaurant[] = [
  ...
  // ---------------------------------------------------------------------------
  // Second bulk-generated batch (Gulshan/Banani/Baridhara), sourced from a
  // fuller live delivery listing. Entries already covered above are skipped.
  // ---------------------------------------------------------------------------
  { name: "Bhagyakul Kacchi Ghor - Banani", cuisines: ["Rice Dishes"], rating: 4.6, reviews: 500, time: 5, fee: 44, deals: ["10% off"], area: "Banani" },
  { name: "Happy Potato Bangladesh - Gulshan 2", cuisines: ["Snacks"], rating: 4.7, reviews: 100, time: 5, fee: 40, area: "Gulshan 2" },
  { name: "Coffee And", cuisines: ["Snacks"], rating: 4.8, reviews: 100, time: 15, fee: 40, deals: ["15% off Tk. 100"] },
  { name: "Clean Cravings - Banani", cuisines: ["Rice Dishes"], rating: 4.9, reviews: 500, time: 10, fee: 40, area: "Banani" },
  { name: "Patenga Point - Banani", cuisines: ["Snacks"], rating: 4.8, reviews: 100, time: 10, fee: 40, deals: ["15% off Tk. 50"], area: "Banani" },
  { name: "Asian Bar-Be-Cue Restaurant", cuisines: ["Bangladeshi"], rating: 4.8, reviews: 5000, time: 15, fee: 54, deals: ["15% off"] },
  { name: "Luscious Food", cuisines: ["Bangladeshi"], rating: 4.7, reviews: 100, time: 35, fee: 63, deals: ["10% off"] },
  { name: "Cranky's", cuisines: ["Chicken"], rating: 4.7, reviews: 100, time: 30, fee: 63, deals: ["Up to 10% off"] },
  { name: "New Nanna Biryani House - Mohakhali", cuisines: ["Biryani"], rating: 3.1, reviews: 1000, time: 25, fee: 44, deals: ["15% off"], area: "Mohakhali" },
  { name: "Chilis Restaurant - Banani", cuisines: ["Chinese"], rating: 4.8, reviews: 100, time: 15, fee: 40, area: "Banani" },
  { name: "Movenpick - Banani", cuisines: ["Dessert"], rating: 4.9, reviews: 94, time: 5, fee: 40, area: "Banani" },
  { name: "Fuchka Factory", cuisines: ["Chotpoti & Fuchka"], rating: 4.3, reviews: 1000, time: 30, fee: 44, deals: ["20% off"] },
  { name: "Cha & Chill - Banani UCSI", cuisines: ["Snacks"], rating: 4.6, reviews: 89, time: 10, fee: 44, area: "Banani" },
  { name: "Jhal Khelei Laal", cuisines: ["Snacks"], rating: 4.5, reviews: 500, time: 25, fee: 49, deals: ["15% off Tk. 50"] },
  { name: "Canton", cuisines: ["Chinese"], rating: 4.9, reviews: 1000, time: 20, fee: 40, deals: ["10% off Tk. 1000"] },
  { name: "Sushi Samurai", cuisines: ["Japanese"], rating: 4.9, reviews: 1000, time: 25, fee: 44 },
  { name: "DIET - Did I Eat That", cuisines: ["Fast Food"], rating: 4.9, reviews: 500, time: 15, fee: 40, deals: ["15% off"] },
  { name: "Wow Momo Foods (Hatirjheel)", cuisines: ["Dumpling"], rating: 4.6, reviews: 1000, time: 25, fee: 49, deals: ["15% off Tk. 50"] },
  { name: "Vorta Bari", cuisines: ["Cafe"], rating: 3.9, reviews: 100, time: 40, fee: 44, deals: ["15% off Tk. 100"] },
  { name: "Rice & Noodles", cuisines: ["Fast Food"], rating: 3.6, reviews: 500, time: 25, fee: 49, deals: ["15% off"] },
  { name: "Fuchka Bhai", cuisines: ["Snacks"], rating: 4.6, reviews: 3000, time: 10, fee: 40, deals: ["15% off Tk. 199"] },
  { name: "Oro Roaster- Banani", cuisines: ["Cafe"], rating: 4.1, reviews: 6, time: 10, fee: 40, deals: ["15% off Tk. 50"], area: "Banani" },
  { name: "Kacchi Ghor", cuisines: ["Biryani"], rating: 2.8, reviews: 1000, time: 10, fee: 40, deals: ["20% off Tk. 50"] },
  { name: "Roll Xpress Cafe", cuisines: ["Rice Dishes"], rating: 4.8, reviews: 1000, time: 10, fee: 44 },
  { name: "The Mezbaan Lounge", cuisines: ["Bangladeshi"], rating: 4.8, reviews: 1000, time: 10, fee: 44, deals: ["10% off Tk. 750"] },
  { name: "Al Amar Lebanese Cuisine - Gulshan", cuisines: ["Lebanese"], rating: 4.8, reviews: 100, time: 15, fee: 35, area: "Gulshan" },
  { name: "KIVA HAN Bistro", cuisines: ["Western"], rating: 4.8, reviews: 2000, time: 20, fee: 40, deals: ["10% off"] },
  { name: "Bao", cuisines: ["Fast Food"], rating: 4.8, reviews: 2000, time: 20, fee: 40, deals: ["10% off"] },
  { name: "Pizza Lover", cuisines: ["Pizza"], rating: 4.1, reviews: 500, time: 30, fee: 44, deals: ["Up to 20% off Tk. 50"] },
  { name: "Ledor- Gulshan-2", cuisines: ["Fast Food"], rating: 4.9, reviews: 100, time: 10, fee: 35, area: "Gulshan" },
  { name: "Burgerography", cuisines: ["Burgers"], rating: 4.6, reviews: 1000, time: 15, fee: 40, deals: ["15% off Tk. 50"] },
  { name: "Thai Signatures - Gulshan", cuisines: ["Thai"], rating: 4.6, reviews: 1000, time: 10, fee: 35, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "Shawarma Sheikh - Gulshan", cuisines: ["Kebab"], rating: 4.5, reviews: 100, time: 10, fee: 40, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "Lavender Food & Bakery -Elegant Square", cuisines: ["Dessert"], rating: 4.9, reviews: 500, time: 5, fee: 35 },
  { name: "Izakaya - Gulshan", cuisines: ["Japanese"], rating: 4.9, reviews: 100, time: 10, fee: 44, area: "Gulshan" },
  { name: "Khao San - Gulshan", cuisines: ["Thai"], rating: 4.8, reviews: 2000, time: 20, fee: 40, area: "Gulshan" },
  { name: "Nawab Chatga", cuisines: ["Rice Dishes"], rating: 4.7, reviews: 2000, time: 10, fee: 40 },
  { name: "Blink", cuisines: ["Dessert"], rating: 4.9, reviews: 100, time: 5, fee: 44 },
  { name: "Big Q - Gulshan", cuisines: ["Fast Food"], rating: 4.8, reviews: 500, time: 15, fee: 40, area: "Gulshan" },
  { name: "Lunchwala- Gulshan", cuisines: ["Khichuri"], rating: 4.1, reviews: 5000, time: 15, fee: 40, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "A Twin Kitchen", cuisines: ["Bangladeshi"], rating: 4.7, reviews: 92, time: 45, fee: 48, deals: ["15% off Tk. 100"] },
  { name: "Cake Storys - Banani", cuisines: ["Dessert"], rating: 4.9, reviews: 100, time: 10, fee: 49, area: "Banani" },
  { name: "Fries & Rice - Gulshan", cuisines: ["Chicken"], rating: 4.2, reviews: 100, time: 15, fee: 40, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "Uzzal Fastfood Chotpoti & Fuchka", cuisines: ["Fast Food"], rating: 4.4, reviews: 1000, time: 10, fee: 44, deals: ["15% off Tk. 50"] },
  { name: "Ruen Busaba", cuisines: ["Thai"], rating: 4.9, reviews: 100, time: 10, fee: 44 },
  { name: "New Dhansiri Biryani House", cuisines: ["Biryani"], rating: 4.2, reviews: 1000, time: 10, fee: 49 },
  { name: "Secret Recipe (Express) - Gulshan 1", cuisines: ["Dessert"], rating: 4.9, reviews: 1000, time: 15, fee: 44, area: "Gulshan" },
  { name: "Roosters Peri Peri-Banani", cuisines: ["Snacks"], rating: 4.9, reviews: 2000, time: 20, fee: 40, deals: ["10% off Tk. 750"], area: "Banani" },
  { name: "Dream Burger - Gulshan", cuisines: ["Burgers"], rating: 4.3, reviews: 100, time: 15, fee: 40, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "C House Milano Bangladesh", cuisines: ["Italian"], rating: 4.9, reviews: 1000, time: 10, fee: 40 },
  { name: "VIP Shad Fuchka & Chotpoti", cuisines: ["Chotpoti & Fuchka"], rating: 4.7, reviews: 2000, time: 5, fee: 44, deals: ["15% off Tk. 50"] },
  { name: "Pizza Roma", cuisines: ["Pizza"], rating: 4.8, reviews: 3000, time: 15, fee: 35 },
  { name: "Crisp - Banani", cuisines: ["Fast Food"], rating: 4.8, reviews: 100, time: 15, fee: 44, area: "Banani" },
  { name: "Aaheli Kabab & Restaurant", cuisines: ["Kebab"], rating: 4.8, reviews: 3000, time: 10, fee: 44 },
  { name: "Shawarma N Katiroll", cuisines: ["Fast Food"], rating: 4.7, reviews: 500, time: 20, fee: 40, deals: ["10% off Tk. 50"] },
  { name: "Turkey Bliss", cuisines: ["Middle Eastern"], rating: 4.8, reviews: 72, time: 20, fee: 49, deals: ["15% off Tk. 100"] },
  { name: "Dine A Chaap - Gulshan", cuisines: ["Kebab"], rating: 4.1, reviews: 100, time: 35, fee: 40, deals: ["10% off Tk. 50"], area: "Gulshan" },
  { name: "Platinum Park", cuisines: ["Pizza"], rating: 4.6, reviews: 500, time: 25, fee: 49, deals: ["15% off Tk. 50"] },
  { name: "Diet Lab", cuisines: ["Healthy"], rating: 4.8, reviews: 15, time: 40, fee: 49, deals: ["15% off"] },
  { name: "Kitchen Stories", cuisines: ["Fast Food"], rating: 4.8, reviews: 28, time: 35, fee: 52, deals: ["10% off Tk. 50"] },
  { name: "Steak Away", cuisines: ["Steak"], rating: 4.7, reviews: 61, time: 35, fee: 49, deals: ["15% off"] },
  { name: "Kudos - Tejgaon Industrial area", cuisines: ["Fast Food"], rating: 4.6, reviews: 1000, time: 40, fee: 54, area: "Tejgaon" },
  { name: "Wrap & Meat Box - Gulshan", cuisines: ["Fast Food"], rating: 4.6, reviews: 100, time: 15, fee: 40, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "Dessert Boutique by Nadia Lakhani", cuisines: ["Cakes"], rating: 4.8, reviews: 500, time: 10, fee: 44 },
  { name: "Nur's Kitchen", cuisines: ["Bangladeshi"], rating: 4.3, reviews: 25, time: 35, fee: 52, deals: ["10% off Tk. 50"] },
  { name: "Panshi Hotel & Restaurant", cuisines: ["Rice Dishes"], rating: 4.4, reviews: 3000, time: 15, fee: 44, deals: ["15% off Tk. 299"] },
  { name: "Only Pasta", cuisines: ["Pasta"], rating: 4.9, reviews: 100, time: 15, fee: 40, deals: ["Up to 15% off"] },
  { name: "The Dumpling Hut- Banani", cuisines: ["Dumpling"], rating: 4.5, reviews: 100, time: 20, fee: 49, deals: ["10% off Tk. 50"], area: "Banani" },
  { name: "Sausly's Foods - Shariotullah Bhaban", cuisines: ["Dessert"], rating: 4.9, reviews: 2000, time: 5, fee: 35 },
  { name: "Royal Arsalan's Kitchen Restaurant", cuisines: ["Curry"], rating: 4.8, reviews: 100, time: 15, fee: 35, deals: ["10% off Tk. 50"] },
  { name: "The Clays BD", cuisines: ["Middle Eastern"], rating: 4.7, reviews: 100, time: 15, fee: 49 },
  { name: "Cooper's - Gulshan 2 Youth Club", cuisines: ["Dessert"], rating: 4.9, reviews: 100, time: 5, fee: 35, area: "Gulshan 2" },
  { name: "Indian Thali - Banani", cuisines: ["Indian"], rating: 2.5, reviews: 8, time: 15, fee: 49, deals: ["15% off Tk. 50"], area: "Banani" },
  { name: "Menjar BD", cuisines: ["Fast Food"], rating: 4.8, reviews: 100, time: 25, fee: 44 },
  { name: "New Shad Biriyani House - Mohakhali", cuisines: ["Biryani"], rating: 3.5, reviews: 3000, time: 25, fee: 44, deals: ["15% off"], area: "Mohakhali" },
  { name: "Happy Tea - Gulshan 2", cuisines: ["Fast Food"], rating: 4.9, reviews: 100, time: 5, fee: 44, area: "Gulshan 2" },
  { name: "The Aromatic Rice - Gulshan", cuisines: ["Rice Dishes"], rating: 4.6, reviews: 100, time: 15, fee: 40, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "Meat Story - Banani", cuisines: ["Meat"], rating: 4.6, reviews: 63, time: 20, fee: 44, deals: ["15% off Tk. 100"], area: "Banani" },
  { name: "Chinatown", cuisines: ["Asian"], rating: 4.9, reviews: 1000, time: 20, fee: 35 },
  { name: "Tandoor By German Butcher", cuisines: ["Kebab"], rating: 4.9, reviews: 100, time: 20, fee: 40, deals: ["12% off Tk. 50"] },
  { name: "Delifrance - Gulshan 2", cuisines: ["Dessert"], rating: 4.9, reviews: 2000, time: 10, fee: 35, area: "Gulshan 2" },
  { name: "Donerci - Flaming Doner", cuisines: ["Wraps"], rating: 4.2, reviews: 1000, time: 15, fee: 44 },
  { name: "Doner Lounge", cuisines: ["Fast Food"], rating: 4.7, reviews: 100, time: 5, fee: 40, deals: ["15% off Tk. 100"] },
  { name: "Rice & Chicken (Set Menu Deal)", cuisines: ["Chicken"], rating: 3.1, reviews: 1000, time: 30, fee: 49, deals: ["20% off"] },
  { name: "Star Bakery - Banani", cuisines: ["Bakery"], rating: 4.9, reviews: 1000, time: 5, fee: 49, area: "Banani" },
  { name: "Urban Crave", cuisines: ["Snacks"], rating: 3.9, reviews: 7, time: 10, fee: 35 },
  { name: "Mithai - Uttar Badda", cuisines: ["Dessert"], rating: 4.6, reviews: 1000, time: 15, fee: 40, area: "Badda" },
  { name: "Bread & Beyond - Gulshan South Avenue", cuisines: ["Dessert"], rating: 4.9, reviews: 100, time: 10, fee: 40, area: "Gulshan" },
  { name: "Baan Busaba", cuisines: ["Chinese"], rating: 4.8, reviews: 100, time: 10, fee: 40 },
  { name: "The Great Kabab Factory - Gulshan", cuisines: ["Kebab"], rating: 4.9, reviews: 500, time: 15, fee: 40, area: "Gulshan" },
  { name: "BOHO - Banani", cuisines: ["Fast Food"], rating: 4.4, reviews: 32, time: 10, fee: 44, area: "Banani" },
  { name: "Fries & More - Gulshan", cuisines: ["Fast Food"], rating: 3.8, reviews: 5000, time: 20, fee: 40, deals: ["10% off Tk. 50"], area: "Gulshan" },
  { name: "Cinnabon - Banani", cuisines: ["Dessert"], rating: 4.4, reviews: 500, time: 10, fee: 44, deals: ["Up to 15% off"], area: "Banani" },
  { name: "Verde Pastry and Bakery - Badda", cuisines: ["Fast Food"], rating: 4.9, reviews: 100, time: 35, fee: 49, area: "Badda" },
  { name: "Dark House Cafe", cuisines: ["Rice Dishes"], rating: 2.6, reviews: 100, time: 25, fee: 49, deals: ["15% off"] },
  { name: "Tehari Box", cuisines: ["Bangladeshi"], rating: 4.7, reviews: 100, time: 30, fee: 52 },
  { name: "Chomp", cuisines: ["Burgers"], rating: 4.7, reviews: 43, time: 25, fee: 40 },
  { name: "Khansaba - Gulshan", cuisines: ["Kebab"], rating: 4.7, reviews: 100, time: 25, fee: 40, deals: ["10% off Tk. 50"], area: "Gulshan" },
  { name: "Kareem's Dhaka", cuisines: ["Kebab"], rating: 4.8, reviews: 100, time: 15, fee: 49 },
  { name: "Grill Theory", cuisines: ["Steak"], rating: 4.7, reviews: 67, time: 15, fee: 40, deals: ["15% off Tk. 100"] },
  { name: "L'eto-Gulshan Avenue", cuisines: ["Cakes"], rating: 4.9, reviews: 500, time: 10, fee: 40, area: "Gulshan" },
  { name: "Ranna Ghor Express", cuisines: ["Bangladeshi"], rating: 2.7, reviews: 100, time: 30, fee: 63, deals: ["15% off Tk. 100"] },
  { name: "King's Confectionery - Gulshan-2", cuisines: ["Cakes"], rating: 4.9, reviews: 500, time: 5, fee: 35, area: "Gulshan" },
  { name: "The Coffee Lounge - Gulshan", cuisines: ["Cafe"], rating: 4.9, reviews: 100, time: 5, fee: 44, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "Kona Cafe", cuisines: ["Cafe"], rating: 4.8, reviews: 1000, time: 15, fee: 40 },
  { name: "Rajbhog Sweets And Bakery", cuisines: ["Sweets"], rating: 4.6, reviews: 52, time: 15, fee: 44, deals: ["15% off Tk. 100"] },
  { name: "TukTuk Express", cuisines: ["Thai"], rating: 4.9, reviews: 8, time: 15, fee: 40, deals: ["10% off Tk. 50"] },
  { name: "Natural food", cuisines: ["Bangladeshi"], rating: 4.8, reviews: 100, time: 35, fee: 63, deals: ["10% off"] },
  { name: "Travel East - Banani", cuisines: ["Japanese"], rating: 4.9, reviews: 100, time: 10, fee: 44, area: "Banani" },
  { name: "Rose Bakery & Bistro", cuisines: ["Beverage"], rating: 4.9, reviews: 500, time: 20, fee: 40, deals: ["Up to 15% off"] },
  { name: "Haji Biryani - Banani", cuisines: ["Rice Dishes"], rating: 4.5, reviews: 100, time: 5, fee: 44, area: "Banani" },
  { name: "Rowshanara Kitchen", cuisines: ["Bangladeshi"], rating: 4.7, reviews: 2000, time: 20, fee: 52, deals: ["15% off Tk. 50"] },
  { name: "YARA - Gulshan", cuisines: ["Sweets"], rating: 4.7, reviews: 100, time: 5, fee: 40, area: "Gulshan" },
  { name: "Arabika Coffee - Banani 11", cuisines: ["Cafe"], rating: 4.8, reviews: 100, time: 10, fee: 40, deals: ["15% off Tk. 50"], area: "Banani" },
  { name: "M/S Ginza", cuisines: ["Asian"], rating: 4.9, reviews: 100, time: 10, fee: 40, deals: ["15% off Tk. 100"] },
  { name: "Farmhouse Burger", cuisines: ["Burgers"], rating: 4.8, reviews: 1000, time: 15, fee: 44 },
  { name: "Gloria Jean's Coffee-Gulshan 1", cuisines: ["Cafe"], rating: 4.9, reviews: 2000, time: 15, fee: 40, area: "Gulshan" },
  { name: "Cafe Sao Paulo - Gulshan", cuisines: ["Fast Food"], rating: 4.9, reviews: 100, time: 10, fee: 44, area: "Gulshan" },
  { name: "Emerald Bakery & Cafe", cuisines: ["Cafe"], rating: 4.9, reviews: 100, time: 10, fee: 40 },
  { name: "Thai Bistro - Gulshan 2", cuisines: ["Chinese"], rating: 4.5, reviews: 500, time: 15, fee: 44, area: "Gulshan 2" },
  { name: "Abacus Restaurant - Gulshan 1", cuisines: ["Asian"], rating: 4.7, reviews: 500, time: 25, fee: 44, deals: ["10% off Tk. 50"], area: "Gulshan" },
  { name: "Biryani On Bowls - Gulshan", cuisines: ["Rice Dishes"], rating: 4.5, reviews: 92, time: 15, fee: 40, deals: ["15% off Tk. 50"], area: "Gulshan" },
  { name: "Rayhan Biryani House", cuisines: ["Biryani"], rating: 4.2, reviews: 500, time: 10, fee: 49 },
  { name: "Jhawbon Classic Restaurant", cuisines: ["Rice Dishes"], rating: 4.6, reviews: 2000, time: 25, fee: 54, deals: ["20% off"] },
  { name: "Wafi's Kitchen", cuisines: ["Bangladeshi"], rating: 4.5, reviews: 100, time: 40, fee: 54, deals: ["15% off Tk. 100"] },
  { name: "Nori", cuisines: ["Japanese"], rating: 4.8, reviews: 100, time: 10, fee: 49 },
  { name: "Lake View", cuisines: ["Fast Food"], rating: 3.6, reviews: 33, time: 30, fee: 40, deals: ["15% off Tk. 100"] },
  { name: "Papa Louie's Pizza Dhaka Bangladesh", cuisines: ["Pizza"], rating: 4.2, reviews: 500, time: 25, fee: 44, deals: ["10% off Tk. 50"] },
  { name: "Mooggi Mama - Gulshan 1", cuisines: ["Fast Food"], rating: 4.3, reviews: 100, time: 20, fee: 44, deals: ["15% off"], area: "Gulshan" },
  { name: "Umai", cuisines: ["Japanese"], rating: 4.9, reviews: 1000, time: 5, fee: 44 },
  { name: "Shahi Daawat - Shahjaadpur", cuisines: ["Rice Dishes"], rating: 5, reviews: 16, time: 15, fee: 44, deals: ["10% off"] },
  { name: "Taste of Lanka", cuisines: ["Fast Food"], rating: 4.8, reviews: 500, time: 15, fee: 40 },
  { name: "Fools Diner", cuisines: ["Japanese"], rating: 4.9, reviews: 3000, time: 10, fee: 40 },
  { name: "Evviva", cuisines: ["Pizza"], rating: 4.9, reviews: 100, time: 15, fee: 35, deals: ["15% off Tk. 50"] },
  { name: "Mermaid Multi Cuisine Restaurant", cuisines: ["Bangladeshi"], rating: 2.5, reviews: 9, time: 40, fee: 40, deals: ["15% off Tk. 50"] },
  { name: "Shad Fuchka Corner", cuisines: ["Chotpoti & Fuchka"], rating: 4.7, reviews: 86, time: 10, fee: 40, deals: ["15% off Tk. 50"] },
  { name: "Pizza Circle", cuisines: ["Pizza"], rating: 4.8, reviews: 15, time: 20, fee: 54, deals: ["20% off Tk. 100"] },
  { name: "Indian Fried Chicken", cuisines: ["Fast Food"], rating: 3.9, reviews: 100, time: 30, fee: 49, deals: ["15% off"] },
  { name: "MUN-SHI", cuisines: ["Fast Food"], rating: 4.7, reviews: 11, time: 20, fee: 40, deals: ["15% off Tk. 50"] },
  { name: "SUMAK", cuisines: ["Fast Food"], rating: 4.8, reviews: 43, time: 10, fee: 44, deals: ["12% off"] },
  { name: "Shaw's Steakhouse", cuisines: ["Steak"], rating: 4.8, reviews: 500, time: 15, fee: 35, deals: ["10% off"] },
  { name: "Deshi Taste House", cuisines: ["Bangladeshi"], rating: 3.3, reviews: 12, time: 25, fee: 35, deals: ["15% off"] },
  { name: "Moolicious", cuisines: ["Beverage"], rating: 4.9, reviews: 1000, time: 10, fee: 40 },
  { name: "Sokal Sandha Biryani House", cuisines: ["Biryani"], rating: 4, reviews: 99, time: 15, fee: 49 },
  { name: "Suruchi Khabar Ghor - Gulshan 2", cuisines: ["Bangladeshi"], rating: 4.8, reviews: 100, time: 5, fee: 40, area: "Gulshan 2" },
  { name: "Slaw Bistro", cuisines: ["Dessert"], rating: 4.9, reviews: 100, time: 30, fee: 54 },
  { name: "Al Kareem Lounge", cuisines: ["Kebab"], rating: 4, reviews: 92, time: 25, fee: 44 },
  { name: "Fruitsicles - Banani", cuisines: ["Dessert"], rating: 4.9, reviews: 100, time: 5, fee: 40, deals: ["10% off Tk. 1049"], area: "Banani" },
  { name: "Momo Mela", cuisines: ["Bangladeshi"], rating: 3.7, reviews: 14, time: 25, fee: 48 },
  { name: "LUNA", cuisines: ["Mexican"], rating: 3.8, reviews: 81, time: 15, fee: 49, deals: ["15% off Tk. 50"] },
  { name: "Thai Times", cuisines: ["Thai"], rating: 4.1, reviews: 100, time: 35, fee: 40, deals: ["15% off Tk. 50"] },
  { name: "BhojBangla", cuisines: ["Bangladeshi"], rating: 4.6, reviews: 500, time: 20, fee: 52, deals: ["12% off Tk. 50"] },
  { name: "Karaachi Dastarkhwan", cuisines: ["Kebab"], rating: 4.5, reviews: 100, time: 25, fee: 40 },
  { name: "The White Canary Cafe", cuisines: ["Fast Food"], rating: 4.9, reviews: 2000, time: 10, fee: 44 },
  { name: "Grounds Coffee Factory", cuisines: ["Beverage"], rating: 4.9, reviews: 100, time: 5, fee: 44, deals: ["12% off"] },
  { name: "Maha Sweets & Pitha", cuisines: ["Dessert"], rating: 4.5, reviews: 50, time: 10, fee: 49, deals: ["15% off Tk. 50"] },
  { name: "Rice & Spice", cuisines: ["Rice Dishes"], rating: 3.5, reviews: 88, time: 25, fee: 49, deals: ["15% off"] },
  { name: "HANDI TEHARI", cuisines: ["Fast Food"], rating: 3.5, reviews: 100, time: 20, fee: 49, deals: ["12% off Tk. 50"] },
  { name: "IZ Patisserie & Cafe-Gulshan", cuisines: ["Dessert"], rating: 4.9, reviews: 100, time: 5, fee: 40, deals: ["10% off"], area: "Gulshan" },
  { name: "Momo House", cuisines: ["Dumpling"], rating: 4.7, reviews: 6, time: 20, fee: 48 },
  { name: "Matsya Kanya Maser Hari Restaurant & Cafe", cuisines: ["Rice Dishes"], rating: 4, reviews: 100, time: 15, fee: 40, deals: ["20% off Tk. 150"] },
  { name: "The Hungry Craft", cuisines: ["Bangladeshi"], rating: 3.6, reviews: 32, time: 25, fee: 49, deals: ["15% off Tk. 50"] },
  { name: "Ninja potato", cuisines: ["Fast Food"], rating: 4.4, reviews: 100, time: 15, fee: 44, deals: ["15% off Tk. 50"] },
  { name: "Kavazo - Banani", cuisines: ["Cakes"], rating: 4.9, reviews: 100, time: 10, fee: 40, area: "Banani" },
  { name: "Thai Momo", cuisines: ["Thai"], rating: 4.8, reviews: 61, time: 15, fee: 48 },
  { name: "Thai Italian pizza", cuisines: ["Bangladeshi"], rating: 2.2, reviews: 37, time: 30, fee: 63, deals: ["20% off Tk. 150"] },
  { name: "PastaMania", cuisines: ["Pasta"], rating: 4.9, reviews: 1000, time: 15, fee: 54, deals: ["20% off Tk. 750"] },
  { name: "Metro Meal", cuisines: ["Fast Food"], rating: 4.3, reviews: 100, time: 30, fee: 49, deals: ["20% off"] },
  { name: "Pizza Milano", cuisines: ["Pizza"], rating: 4.4, reviews: 100, time: 25, fee: 40 },
  { name: "Rice Bowl", cuisines: ["Fast Food"], rating: 2.9, reviews: 100, time: 25, fee: 63, deals: ["10% off Tk. 50"] },
  { name: "Cocojoy", cuisines: ["Beverage"], rating: 4.9, reviews: 100, time: 15, fee: 44, deals: ["BOGO"] },
  { name: "AM 2 PM", cuisines: ["Fast Food"], rating: 4.5, reviews: 100, time: 35, fee: 52, deals: ["12% off Tk. 50"] },
  { name: "Galore of Seoul & Tokyo", cuisines: ["Japanese"], rating: 4.6, reviews: 100, time: 25, fee: 54, deals: ["12% off"] },
  { name: "Bowls Spot", cuisines: ["Rice Dishes"], rating: 4.1, reviews: 100, time: 25, fee: 40, deals: ["15% off Tk. 100"] },
  { name: "Awake Coffee Roasters - Banani", cuisines: ["Beverage"], rating: 4.7, reviews: 100, time: 10, fee: 40, area: "Banani" },
  { name: "Amai", cuisines: ["Bakery"], rating: 4.6, reviews: 68, time: 10, fee: 44 },
  { name: "The Sea Food Corner", cuisines: ["Seafood"], rating: 4.6, reviews: 74, time: 25, fee: 44, deals: ["12% off Tk. 449"] },
  { name: "Wa Wa Waffles - Badda", cuisines: ["Dessert"], rating: 3.3, reviews: 100, time: 50, fee: 49, deals: ["15% off Tk. 50"], area: "Badda" },
];
