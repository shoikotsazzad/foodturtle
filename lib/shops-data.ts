...
const RAW_NAMED_SHOPS: RawShop[] = [
  ...
  // ---------------------------------------------------------------------------
  // Second bulk-generated batch, sourced from a fuller live shops listing.
  // ---------------------------------------------------------------------------
  { name: "Agora", type: "Convenience", time: 10 },
  { name: "Toy & Beyonds", type: "Stationery And Books", time: 20 },
  { name: "Dhaka Fresh Mart", type: "Supermarket", time: 20 },
  { name: "Gausia Fish Traders (Banani)", type: "Butchery & Fishery", time: 10 },
  { name: "Mohakhali Kacha Bazar", type: "Fruits & Vegetables", time: 25 },
  { name: "Brothers Enterprise (Gulshan 2)", type: "Convenience", time: 15 },
  { name: "Bazaar Lagbe", type: "Convenience", time: 10 },
  { name: "Banani Blooms (Banani)", type: "Flowers & Plants", time: 25 },
  { name: "Wholesale Express BD", type: "Convenience", time: 35 },
  { name: "Fresh Supermarket", type: "Supermarket", time: 15 },
  { name: "Global Grocery", type: "Supermarket", time: 25 },
  { name: "RAFAMART", type: "Supermarket", time: 15 },
  { name: "Shopper Bangladesh", type: "Convenience", time: 15 },
  { name: "Signature Mart (Gulshan 1 DNCC Kacha Bazar)", type: "Fruits & Vegetables", time: 25 },
  { name: "Universal Grocery Shop", type: "Supermarket", time: 25 },
  { name: "Rainbow Mart", type: "Supermarket", time: 15 },
  { name: "Mersas Pushpo General Store", type: "Flowers & Plants", time: 20 },
  { name: "Ramna Pharmacy & Departmental Store (Gulshan 2)", type: "All In One Pharmacy", time: 5 },
  { name: "The Grocery Supermart", type: "Supermarket", time: 10 },
  { name: "Fresh Super Mart (Gulshan)", type: "Supermarket", time: 10 },
  { name: "RFL Best Buy Pharma (Niketan)", type: "All In One Pharmacy", time: 20 },
  { name: "Adiba Chocolate Mart", type: "Snacks And Sweets", time: 15 },
  { name: "Mahmud Pharmacy (Banani)", type: "All In One Pharmacy", time: 20 },
  { name: "VIP Community Mart", type: "Supermarket", time: 10 },
  { name: "Cat Food", type: "Pets", time: 25 },
  { name: "Gulshan Pharma Plus", type: "All In One Pharmacy", time: 10 },
  { name: "Everrise Supermarket", type: "Supermarket", time: 15 },
  { name: "Family Grocery Store", type: "Supermarket", time: 20 },
  { name: "New Pushpo Koli Center", type: "Flowers & Plants", time: 25 },
  { name: "Fruit Factory Supershop", type: "Fruits & Vegetables", time: 20 },
  { name: "Borno Bazar Gulshan", type: "Convenience", time: 20 },
  { name: "RafaMart Puspo Bitan", type: "Supermarket", time: 25 },
  { name: "The Smoking Room", type: "Tobacco", time: 10 },
  { name: "Parvez General Store", type: "Supermarket", time: 20 },
  { name: "Smokers Zone", type: "Tobacco", time: 10 },
  { name: "Taza Bazar", type: "Fruits & Vegetables", time: 30 },
  { name: "Gulshan Flower Centre", type: "Flowers & Plants", time: 20 },
  { name: "Fresh Organic Mart", type: "Supermarket", time: 35 },
  { name: "Sarwar Electric & Mobile Gadget Store", type: "Electronics", time: 15 },
  { name: "Al-Fatah Flower Shop", type: "Flowers & Plants", time: 10 },
  { name: "Banani Flower Center (Banani)", type: "Flowers & Plants", time: 10 },
  { name: "The Eastern Pickle Company", type: "Snacks And Sweets", time: 20 },
  { name: "Bengal Meat - Dhali (DCC Market)", type: "Butchery & Fishery", time: 20 },
  { name: "Maa Babar Doya Fruit Store", type: "Fruits & Vegetables", time: 20 },
  { name: "Meat Market", type: "Butchery & Fishery", time: 20 },
  { name: "Cerrefour Supermarket", type: "Supermarket", time: 20 },
  { name: "World Grocery Shop", type: "Supermarket", time: 20 },
  { name: "Diplomat Mart", type: "Supermarket", time: 20 },
];
